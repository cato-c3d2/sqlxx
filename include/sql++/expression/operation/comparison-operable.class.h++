...
inline namespace expression
{
    ...
    public:
         ...
         *                    演算される≪式≫として≪式≫のオブジェクトだけではなく、≪リテラル式≫の内部値を指定することが可能。
         *
         * @return ≪等値比較演算式≫
         */
         ...
         *
         * このオブジェクトを左辺の≪式≫、
         * @c operand を右辺の≪式≫とした、≪比較演算式（小なり）≫を生成する。
         *
         * このメンバ関数の名称は、標準ライブラリ関数
         ...
         *
         * このオブジェクトを左辺の≪式≫、
         * @c operand を右辺の≪式≫とした、≪比較演算式（以下）≫を生成する。
         *
         * このメンバ関数の名称は、標準ライブラリ関数
         * @c std::less_equal （ @c \<functional\> ）を参考に命名した。
         *
         ...
         *
         * このオブジェクトを左辺の≪式≫、
         * @c operand を右辺の≪式≫とした、≪比較演算式（大なり）≫を生成する。
         *
         * このメンバ関数の名称は、標準ライブラリ関数
         * @c std::less_equal （ @c \<functional\> ）を参考に命名した。
         *
         ...
         *
         * このオブジェクトを左辺の≪式≫、
         * @c operand を右辺の≪式≫とした、≪比較演算式（以上）≫を生成する。
         *
         * このメンバ関数の名称は、標準ライブラリ関数
         * @c std::less_equal （ @c \<functional\> ）を参考に命名した。
         *
         ...
         *
         * このオブジェクトを左辺の≪式≫、
         * @c operand を右辺の≪式≫とした、≪IS演算式≫を生成する。
         *
         * @param[in] operand 右辺の≪式≫
         *                    演算される≪式≫として≪式≫のオブジェクトだけではなく、≪リテラル式≫の内部値を指定することが可能。
         *
