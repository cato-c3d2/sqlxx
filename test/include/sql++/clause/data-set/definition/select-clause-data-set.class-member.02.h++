/*!
 * @file select-clause-data-set.class-member.02.h++
 */

#ifndef TEST__INCLUDE__SQLXX__CLAUSE__DATA_SET__DEFINITION__SELECT_CLAUSE_DATA_SET_CLASS_MEMBER_02_HXX
#define TEST__INCLUDE__SQLXX__CLAUSE__DATA_SET__DEFINITION__SELECT_CLAUSE_DATA_SET_CLASS_MEMBER_02_HXX
...
inline namespace clause
{
     ...
     * @li @c as_clause : 未指定, 空文字列, 不適格(半角スペース) or 適格適格
     *
     * @return データセット
     *
     ...
     */
    auto SelectClauseDataSet::for_some_test_case_02()
...
#endif /* TEST__INCLUDE__SQLXX__CLAUSE__DATA_SET__DEFINITION__SELECT_CLAUSE_DATA_SET_CLASS_MEMBER_02_HXX */
